...
import { Clock, User, Info, AlertTriangle, XCircle, Bug, Code, Activity, Trash2 } from 'lucide-react';
        ...
        <div className="flex items-start justify-between gap-3">
          {showSelection && (
            <div className="mt-1">
              <Checkbox
                checked={isSelected}
                onCheckedChange={(checked) => onSelect?.(log.id, checked as boolean)}
          ...
          <div className="flex items-start gap-3 flex-1">
            ...
            <div className="flex-1 space-y-2">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <Badge variant="outline" className="text-xs bg-purple-500/10 text-purple-400 border-purple-400/30">
                  {log.application}
                </Badge>
